...
export default function BuyPRDX({ onClose }: BuyPRDXProps) {
  const handleCopyAddress = () => {
    navigator.clipboard.writeText('0xAFEe9745Cfa34a9b552e9C6c7848e601b42Fca14');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <p className="font-medium text-sm text-primary-300 break-all">0xAFEe9745Cfa34a9b552e9C6c7848e601b42Fca14</p>
                    <button
            ...
            <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-lg p-6 border border-white/10 shadow-lg">
              ...
              <a
                href="https://app.uniswap.org/#/swap?outputCurrency=0xAFEe9745Cfa34a9b552e9C6c7848e601b42Fca14"
                target="_blank"
